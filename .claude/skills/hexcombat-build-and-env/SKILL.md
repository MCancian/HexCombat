...
description: Recreate or repair the HexCombat working environment — Godot binary, class-cache import, GdUnit4, MCP, opencode — and the known environment traps on this Windows box. Use on a fresh checkout, after adding scripts, when imports/tests fail mysteriously, or when a tool won't launch.
---
