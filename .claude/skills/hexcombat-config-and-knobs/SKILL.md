...
| Red/contested ownership tint weight (0.35; Green-held/unowned hexes render pure terrain color) | Code-resident literal, `scripts/HexMap.gd` (`terrain_color.lerp(ownership_color, 0.35)` in `get_hex_color`) — not scenario/data-driven | `HexMap.get_hex_color` (view) |
