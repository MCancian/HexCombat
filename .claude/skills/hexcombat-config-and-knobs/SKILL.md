...
| Terrain/ownership blend weight (0.35, terrain-dominant) | Code-resident literal, `scripts/HexMap.gd:361` (`terrain_color.lerp(ownership_color, 0.35)`) — not scenario/data-driven | `HexMap.get_hex_color` (view) |
