...
`tools/validate_headless_turn.gd`, seed **20260624**, must print **casualties=3, feba=-0.96**
(current baseline — read the validator, don't trust this file, if they disagree).
