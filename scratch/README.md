...
So: echo the loaded parameter, and assert the edit applied. If a probe mutates a committed data
file, restore it and confirm with `git status --short` before trusting any number.
