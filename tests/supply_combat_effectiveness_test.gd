...
func test_exhausted_supply_lowers_attacker_strength() -> void:
	...
	var res_full: CombatResult = CombatCalculator.resolve_map_attack(dice, full, defenders, {}, {}, [], [], CombatRules.new())
	...
	var res_degraded: CombatResult = CombatCalculator.resolve_map_attack(dice2, degraded, defenders, {}, {}, [], [], CombatRules.new())
