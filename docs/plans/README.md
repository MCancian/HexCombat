...
| 0060 | [Should air attrition happen before Red strikes?](0060-air-attrition-before-the-strike.md) | Medium (balance; USER question 2026-08-01. Two of three air-attrition sources fire AFTER the strike, so aircraft killed by MANPADS or the free shot still flew their mission. Moving them is NOT a neutral reorder — killed aircraft stop striking AND more shooters are alive to kill them, compounding into a real Red nerf; the free shot's post-strike position is definitional. Certain golden re-baseline + study re-run; the sensitivity comparison IS the deliverable) | Sketch |
