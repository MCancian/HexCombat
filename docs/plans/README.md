...
| 0038 | [TurnConductor phase extraction](0038-turnconductor-phase-extraction.md) | Medium (refactor; ndeps 38 of 38 — the next phase resolver breaks the gate and the ceiling may not be raised. Pure restructuring, no design calls, no behaviour change; byte-stability is the whole acceptance test) | In progress (steps 1-2 shipped: ndeps 38 → 22) |
