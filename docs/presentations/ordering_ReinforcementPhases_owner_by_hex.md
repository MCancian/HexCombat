# Ordering: `ReinforcementPhases.owner_by_hex`
...
Source: `scripts/phases/ReinforcementPhases.gd:201`
...
```mermaid
flowchart TD
  n_b6c89c951ad8["1. GameDataStore.hex_owner_of (line 204)"]
```
...
|---:|---|---|---|---|
| 1 | `GameDataStore.hex_owner_of` at `scripts/phases/ReinforcementPhases.gd:204` | `GameDataStore.hex_states`, `HexState.hex_owner` | — | — |
