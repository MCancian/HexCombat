...
| [`IjfsManpads._ready_in_to`](IjfsManpads.md) | `IjfsManpads.systems_remaining` at `192` |
| [`IjfsManpads._sorted_ready_bins`](IjfsManpads.md) | `IjfsManpads.systems_remaining` at `204` |
| [`IjfsManpads.engage_package`](IjfsManpads.md) | `IjfsManpads._ready_in_to` at `110` |
| [`IjfsManpads.engage_package`](IjfsManpads.md) | `IjfsManpads.threat_fraction` at `112` |
| [`IjfsManpads.engage_package`](IjfsManpads.md) | `IjfsManpads.expend` at `149` |
| [`IjfsManpads.engages`](IjfsManpads.md) | `IjfsManpads._ready_in_to` at `93` |
| [`IjfsManpads.expend`](IjfsManpads.md) | `IjfsManpads._sorted_ready_bins` at `176` |
| [`IjfsManpads.expend`](IjfsManpads.md) | `IjfsManpads.systems_remaining` at `179` |
| [`IjfsManpads.expend`](IjfsManpads.md) | `IjfsManpads.set_remaining` at `181` |
| [`IjfsManpads.ready_systems_by_to`](IjfsManpads.md) | `IjfsManpads.systems_remaining` at `53` |
| [`IjfsManpads.systems_remaining`](IjfsManpads.md) | `IjfsManpads.set_remaining` at `68` |
...
| [`IjfsResolver.sync_manpads_to_oob`](IjfsResolver.md) | `IjfsManpads.systems_remaining` at `141` |
...
flowchart LR
  ...
  n_1383531da965["IjfsManpads.systems_remaining"] --> n_3fd3e979604d
...
| `systems_remaining` | `IjfsManpads.set_remaining` |
| `threat_fraction` | — |
