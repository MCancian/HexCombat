...
| `scripts/PolicyCatalog.gd` | Policy registry (`selfplay_default`, `inland_clear`, `garrison_draw`, `llm_local`); `create_for_seat` configures seat-aware policies and unknown ids fail loud. |
