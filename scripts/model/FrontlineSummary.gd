...
## order and value types mirror the former dict exactly. pinned by: tools/validate_llm_api.gd
## (deep drift check). A null last_frontline_summary means the phase has not resolved this turn.
